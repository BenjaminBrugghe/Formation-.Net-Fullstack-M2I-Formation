...
namespace Ex3_ListeContacts.Classes
{
    public class Contact : Person
    {
        ...
        public static ObservableCollection<Contact> GetAll()
        {
        ...
        public (bool, string) Delete()
        {
            ...
            return (nbLignes > 0, nbLignes > 0 ? $"Le contact N°{Id} a été supprimé" : "Erreur lors de la suppression du contact");
        }
